        ...
        ${
          state.tab === "channels"
            ? renderChannels({
                ...
                expandedChannelId: state.channelsExpandedId,
                activeChannelTab: state.channelsActiveTab,
                onChannelExpand: (channelId) => state.handleChannelExpand(channelId),
                onChannelCollapse: () => state.handleChannelCollapse(),
                onChannelTabChange: (tab) => state.handleChannelTabChange(tab),
